...
start_service storefront env STOREFRONT_PORT=8010 ORCHESTRATOR_URL=http://localhost:8004 node_modules/.bin/tsx --env-file-if-exists=.env web/storefront/src/server.tsx

echo "[container] storefront:   http://localhost:8010"
